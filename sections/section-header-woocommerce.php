...
$pixova_lite_woocommerce_title = get_theme_mod( 'pixova_lite_woocommerce_title', __( 'WooCommerce', 'high-star' ) );
$pixova_lite_woocommerce_description = get_theme_mod( 'pixova_lite_woocommerce_description', esc_html__( 'We have the best products.', 'high-star' ) );
?>
