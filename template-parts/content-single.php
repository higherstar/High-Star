            ...
            <?php } ?>
              ...
              ?>
                <div class="row mt-author-area">
                    ...
                    <div class="col-lg-11">
                        <h3> <?php _e('About the author: ', 'high-star'); ?> <a class="mt-author-link" href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" rel="author"><?php echo get_the_author(); ?></a></h3>
