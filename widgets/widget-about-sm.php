...
class Pixova_Lite_Widget_About extends WP_Widget {
    ...
    function Pixova_Lite_Widget_About() {
        ...
        $widget_ops = array(
            ...
            'description' => __('A widget that displays about text & social media counts. Designed for footer', 'high-star')
        );
        ...
        parent::__construct( 'pixova_lite_widget_about', __('[MT] - About', 'high-star'), $widget_ops, $control_ops );
    }
    ...
    function form( $instance ) {
        ...
        <div class="macho-meta">
          ...
          <p>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('about_text'); ?>"><?php _e('About us', 'high-star'); ?></label>
